...
if (isset($_POST['submit'])) {
    ...
    $checkcategory = "SELECT * FROM `categories` WHERE `name` = '$category_name'";
    $resultcheckcategory = mysqli_query($conn, $checkcategory);
    $categorycount = mysqli_num_rows($resultcheckcategory);
    if ($categorycount == 0) {
        $addcategory = "INSERT INTO `categories`(`name`, `visibility`,`date`) VALUES ('$category_name','$visibility','$date')";
        $insert = mysqli_query($conn, $addcategory);
    } else {
        ?>
                        ...
                        <div class="app-card app-card-settings shadow-sm p-4">
                            ...
                            <div class="app-card-body">
                                <form class="settings-form" action="" method="post">
                                    ...
                                    <button type="submit" name="submit" class="btn app-btn-primary">Save
                                        Changes</button>
                                </form>
                            </div>
                            <!--//app-card-body-->
