...
if (isset($_POST['submit'])) {
    ...
    foreach ($subcategoryname as $key => $value) {
        $save = "INSERT INTO sub_categories(`c_id`,`name`,`visibility`,`date`) VALUES ('" . $cid . "','" . $value . "','" . $visibility[$key] . "','" . $date . "')";
        $savedate = mysqli_query($conn, $save);
                    ...
                    <div class="col-12 col-md-12">
                        <div class="app-card app-card-settings shadow-sm p-4">
                            ...
                            <div class="app-card-body">
                                <form class="settings-form" action="" method="post" id="sub-categories-data">
                                    <div class="mb-3 col-md-12">
                                        <div class="form-row form-group">
                                            <label for="visibility" class="form-label">Select Category*</label>
                                            <select id="c_id" name="c_id" class="form-control" required>
                                                <option value="" selected="selected">Select Category</option>
                                                <?php
                                                while ($fetchcategories = mysqli_fetch_array($categories)) { ?>
                                    ...
                                    <div id="show_items">
                                        <div class="row">
                                            <div class="mb-3 col-md-4">
                                                <label for="visibility" class="form-label">Sub category*</label>
                                                <input type="text" placeholder="Sub Category Name"
                                                    class="form-control search-input" name="sub-category-name[]"
                                                    required>
                                            </div>
                                            <div class="mb-3 col-md-4">
                                                <div class="form-row form-group">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                <label for="visibility" class="form-label">Action</label><br>
                                                <button class="btn app-btn-primary add_item_btn">Add</button>
                                            </div>
                                        </div>
                                    </div>
                                    <button type="submit" id="submit" name="submit" class="btn app-btn-primary">Save
                                        Changes</button>
                                </form>
                            </div>
                            <!--//app-card-body-->
        ...
        <script>
            $(document).ready(function () {
                $(".add_item_btn").click(function (e) {
                    e.preventDefault();
                    $("#show_items").append(`<div class="row">
                                            <div class="mb-3 col-md-4">
                                                <input type="text" placeholder="Sub Category Name"
                                                    class="form-control search-input" name="sub-category-name[]"
                                                    required>
                ...
                //$("#sub-categories-data").submit(function(e){
                //  e.preventDefault();
                //$("#submit").val('Adding...');
                //$.ajax({
                //  url:'action.php',
