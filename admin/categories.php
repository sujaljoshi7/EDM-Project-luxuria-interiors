                    ...
                    <div class="col-auto">
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                ...
                                <div class="col-auto">
                                    <a class="btn app-btn-primary" href="add_category.php">
                                ...
                                <div class="col-auto">
                                    <a class="btn app-btn-secondary" href="add_sub_category.php">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd"
                                                d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2" />
                                    ...
                                    <table class="table table-hover mb-0 text-left custom-table-pointer">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="cell">Sub categories</th>
                                        ...
                                        <tbody>
                                            <?php while ($row = mysqli_fetch_array($fetchcategories)) { ?>
                                                <tr>
                                                    <?php $cid = $row['c_id'] ?>
                                                    <td class="cell"><?php echo $cid ?></td>
                                                    <td class="cell"><a
                                                            href="sub_categories.php?c_id=<?php echo $cid ?>"><span
                                                                class="truncate"><?php echo $row['name'] ?></span></a>
                                                    </td>
                                                    <td class="cell"><span><?php echo $row['date'] ?></span>
                                                    </td>
                                                    <?php
                                                    $checkproducts = "SELECT * FROM `products` WHERE `c_id` = '$cid'";
                                                    $resultcheckproducts = mysqli_query($conn, $checkproducts);
                                                    $productcount = mysqli_num_rows($resultcheckproducts);
                                                    ?>
                                                    <td class="cell"><?php echo ($productcount) ?>
                                                    </td>
                                                    <?php
                                                    ...
                                                    <td class="cell"><?php echo ($categorycount) ?>
                                                    </td>
