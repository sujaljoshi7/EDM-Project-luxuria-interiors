                    ...
                    <div class="col-auto">
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                ...
                                <div class="col-auto">
                                    <a class="btn app-btn-primary" href="add_product.php">
                            ...
                            <div class="app-card-body">
                                <div class="table-responsive">
                                    <table class="table app-table-hover mb-0 text-left">
                                        <thead>
                                            <tr>
                                                <th class="cell">Product id(sku)</th>
                                        ...
                                        <tbody>
                                            <?php while ($row = mysqli_fetch_array($fetchproducts)) { ?>
                                                <tr>
                                                    <?php $pid = $row['p_id'] ?>
                                                    <td class="cell"><?php echo $row['sku'] ?></td>
                                                    <td class="cell"><img
                                                            src="../assets/images/product-images/<?php echo $row['image'] ?>"
                                                            alt="product image" height="50px"></td>
                                                    <td class="cell"><span
                                                            class="truncate"><?php echo $row['name'] ?></span></td>
                                                    <td class="cell"><?php echo $row['stock'] ?>
                                                    </td>
                                                    <td class="cell">₹<?php echo $row['mrp'] ?>/-</td>
                                                    <td class="cell">₹<?php echo $row['price'] ?>/-</td>
                                                    <?php
                                                    $c_id = $row['c_id'];
                                                    $categoriessql = "SELECT * FROM categories where c_id = $c_id";
                                                    $fetchcategories = mysqli_query($conn, $categoriessql);
                                                    $categories = mysqli_fetch_array($fetchcategories);
                                                    ?>
                                                    <td class="cell"><span
                                                            class="truncate"><?php echo $categories['name'] ?></span></td>
                                                    <?php
                                                    $s_c_id = $row['s_c_id'];
                                                    $subcategoriessql = "SELECT * FROM sub_categories where s_c_id = $s_c_id";
                                                    $fetchsubcategories = mysqli_query($conn, $subcategoriessql);
                                                    $subcategories = mysqli_fetch_array($fetchsubcategories);
                                                    ?>
                                                    <td class="cell"><span
                                                            class="truncate"><?php echo $subcategories['name'] ?></span>
                                                    </td>
                                                    <td class="cell"><span
                                                            class="truncate"><?php echo $row['date'] ?></span></td>
